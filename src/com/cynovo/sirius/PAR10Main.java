...
import com.cynovo.sirius.util.communicate.PollService;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        {  
            ...
            {                   
    			...
    			Bundle translateBundle = ActivityOptions.makeCustomAnimation(PAR10Main.this,android.R.anim.fade_in,android.R.anim.fade_out).toBundle();
