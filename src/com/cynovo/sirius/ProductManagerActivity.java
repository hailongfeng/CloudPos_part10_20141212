...
import com.cynovo.sirius.fragment.BackFragment;
import com.cynovo.sirius.fragment.ProductManagerFragment;
import com.cynovo.sirius.fragment.SettingFragment;
import com.cynovo.sirius.fragment.SettingMerchantFragment;
import com.cynovo.sirius.fragment.UserManagerFragment;
...
public class ProductManagerActivity extends ProductBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MyTabListener goodsListener = new MyTabListener(new ProductManagerFragment());
...
//		Tab membershipTab = actionbar.newTab().setText(getResources().getText(R.string.membership_system));
//		membershipTab.setIcon(R.drawable.setting);
//		MyTabListener membershipListener = new MyTabListener(new MemberFragment());
