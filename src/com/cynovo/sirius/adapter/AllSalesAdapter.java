...
public class AllSalesAdapter extends BaseExpandableListAdapter {
	...
	public int getGroupIndexByTime(String dateStr)
	{
		...
		{
			String tmpDatestr = Common.getDateTimeString(mListGroup.get(i).get(0).getOrder().getModifyTime(), "yyyy-MM-dd");
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		String datestr = Common.getDateTimeString(mListGroup.get(groupPosition).get(0).getOrder().getModifyTime(), "  yyyy-MM-dd");
		tvt.setText(datestr);
		return mtmp;
	}
