...
public class AttributeAdapter extends BaseAdapter{
	 ...
	 {
		 if(attr1.getProductAttributeID() == attr2.getProductAttributeID() &&
				 attr1.getName().equals(attr2.getName()) &&
				 attr1.getChoiceType() == attr2.getChoiceType() &&
				 attr1.getDefaultChoice() == attr2.getDefaultChoice() &&
				 attr1.getEnable() == attr2.getEnable() )
			 return true;
		 else
			 return false;
	 }
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			holder.check = (CheckBox) convertView.findViewById(R.id.prdmg_att_listdeletbtn);
