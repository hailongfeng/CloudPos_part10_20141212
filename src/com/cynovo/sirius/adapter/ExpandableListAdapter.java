...
//		Bitmap newBmp = Bitmap.createScaledBitmap(bmp, 80, 80, filter)
		...
		//((ImageView) convertView.getTag(R.id.leftbarpauseideal)).setBackground(imageview);
		//((TextView) convertView.getTag(R.id.leftbarmoney)).setText(textshowMoney);
		holder.showchildMoney.setText(textshowMoney);
		//((TextView) convertView.getTag(R.id.leftbarkind)).setText(textshowName);
		holder.showchildName.setText(textshowName);
		holder.showchildTime.setText(textshowTime);
		//((TextView) convertView.getTag(R.id.leftbarkind)).setCompoundDrawables(imageview, null, null, null);
		//((TextView) convertView.getTag(R.id.leftbarkind)).setText(textshowTime);
