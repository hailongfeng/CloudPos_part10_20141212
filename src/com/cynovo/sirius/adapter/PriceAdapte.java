...
import com.cynovo.sirius.fragment.ProductManagerAttrFragment;
...
public class PriceAdapte extends BaseAdapter {
	...
	public PriceAdapte(ProductManagerAttrFragment mProductManagerAtrrrFragment,
			List<ProductSubAttribute> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final CheckView holder = new CheckView(
				mProductManagerAtrrrFragment.getActivity());
		...
		holder.deletBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (holder.isChecked && pos == PriceAdapte.this.getCount()
						&& pos != 0)
	...
	public class CheckView extends RelativeLayout implements Checkable {
		...
		public CheckView(Context context) {
			...
			LayoutInflater.from(context).inflate(
					R.layout.productmanager_attr_price_item_layout, this, true);
			showTextView = (TextView) this
					.findViewById(R.id.prdmg_attr_price_list_textview);
			showTextPrice = (TextView) this
					.findViewById(R.id.prdmg_attr_price_list_price);
			deletBtn = (Button) this
					.findViewById(R.id.prdmg_att_price_listdeletbtn);
			mImageVIew = (ImageView) this.findViewById(R.id.image_bg_sub);
			AbsListView.LayoutParams clp = new AbsListView.LayoutParams(
