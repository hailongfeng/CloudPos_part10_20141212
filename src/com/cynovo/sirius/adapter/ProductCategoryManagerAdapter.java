...
public class ProductCategoryManagerAdapter extends BaseAdapter {
    ...
    public ProductCategoryManagerAdapter(ProductManagerFragment mf,List<ProductCategory> categoryList){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(position > 0)
		{
			...
			int count = ProductManager.getProductCountByCategory(mCategoryList.get(position-1).getProductCategoryId());
