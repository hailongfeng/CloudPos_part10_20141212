...
public class RecentSalesAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		int orderStatus = mListGroup.get(getPositionInList(groupPosition)).get(childPosition).getOrder().getOrderStatusID();
		if(orderStatus == OrderStatus.ORDER_HANGUP.toInt())
		{
			holder.notPay.setText(R.string.notpay);
			holder.orderTime.setText(Common.getSerialNumberFromBillNo(mListGroup.get(getPositionInList(groupPosition)).get(childPosition).getOrder().getBillNo()));
		}
