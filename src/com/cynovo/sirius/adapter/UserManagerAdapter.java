...
//    	int privilege = accountManager.getCurrentAccount().getAccountPrivilege();
//    	if(privilege == 3) {
...
//    	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.accountName.setText((accountList.get(position).getLastName()==null?"":
				accountList.get(position).getLastName()) +
				(accountList.get(position).getFirstName()==null?"":
				accountList.get(position).getFirstName())
				);
