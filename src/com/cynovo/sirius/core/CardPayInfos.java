...
import com.cynovo.sirius.core.order.BankCard;
import com.cynovo.sirius.core.order.OrderCustomerInfo;
...
public class CardPayInfos {
	...
	{
		OrderProcess mOrderProcess = new OrderProcess(-1,mOrderProcessMode.toInt(),-1,-1,null,
				traceNo,null,null,null,null,price,null,null,null);
