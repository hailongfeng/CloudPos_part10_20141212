...
public class DealModel {
	...
	public void onOrderProcessStatusChanged(int newProcess)
	{
		...
		case ORDER_PROCESS_INIT:
			...
			if(mContext != null)
			{
				...
				Bundle translateBundle = ActivityOptions.makeCustomAnimation(mContext,android.R.anim.fade_in,android.R.anim.fade_out).toBundle();
	...
	public void RecoverOrderData(OrderData mOrderData) 
	{
		...
		this.OrderInfo.setInitOlderHangUpList(OrderManager.getOrderDataById(mOrderData.getCurrentOrder().getOrderID()).getOrderContentList());
		this.OrderInfo.setOrderContentList(mShoppingCart.getOrderContentList());
