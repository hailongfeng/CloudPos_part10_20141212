...
public class OrderChangeInfo{
	...
	public String toString() {
		return "OrderChangeInfo [productID=" + productID + ", onePrice="
				+ onePrice + ", oldIndex=" + oldIndex + ", newIndex="
				+ newIndex + ", isAllSame=" + isAllSame + ", onlyCountChange="
				+ onlyCountChange + ", countChanged=" + countChanged
				+ ", changeFlag=" + changeFlag + ", amountChange="
				+ amountChange + "]";
	}
