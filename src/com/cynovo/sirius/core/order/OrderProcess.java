...
public class OrderProcess {
	...
	public OrderProcess(int orderProcessId, int orderProcessModeId,
			int orderID, int addressID, String createTime, String traceNo,
			String referenceNo, String authorizationNo, String clearingDate,
			String ackNo, String price, String issuerbankid, String acqbankid,
			String batchid) {
