...
public class Orders{
	...
	public Orders(int orderID, String billNo,long createTime, long modifyTime, int OrderStatusID) {
	...
	public Orders(int orderID, String billNo,long createTime, long modifyTime, int OrderStatusID, int syncflag) {
		this.orderID = orderID;
		this.billNo = billNo;
		this.createTime = createTime;
		this.modifyTime = modifyTime;
