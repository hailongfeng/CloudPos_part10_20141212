package com.cynovo.sirius.core.setting;
...
//	private String terminalNo;
	...
	public Settings(String cynovoIP, int cynovoPort, String cardlinkIP,
			int cardlinkPort, String serialNumber, String traceNo) {
...
//	}
	...
	public String getSerialNumber() {
		if(serialNumber.length() != SERIALNUMLENGTH || !serialNumber.substring(0, 2).equals(Common.getCurrentDateTimeString("dd")))
		{
	...
	public String getAndIncTraceNo() {
		...
		if (tempTraceNoString.equals("999999"))
			...
			traceNo = String.format("%06d",
					(Integer.valueOf(tempTraceNoString) + 1));
	...
	public String incAndGetSerialNumber() {
		...
		if (tempSerialNoString.equals("999999"))
			...
			setSerialNumber(String.format("%06d",
					(Integer.valueOf(tempSerialNoString) + 1)));
		SettingsManager.updateSerialNumber(serialNumber);
