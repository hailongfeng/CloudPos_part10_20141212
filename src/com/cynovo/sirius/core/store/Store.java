...
public class Store {
	...
	@Expose private int storeAddressID;
	@Expose private int companyAddressID;
	@Expose private String storeName;
	@Expose private String storePhoto;
	@Expose private String companyName;
	@Expose private String companyPhoto;
	@Expose private String nickName;
	@Expose private String address;
	@Expose private String companyAddress;
	...
	public Store(int storeID, int storeAddressID, int companyAddressID,
			String storeName, String storePhoto, String companyName,
			String companyPhoto, String nickName, String address,String companyAddress) {
	...
	public void setInfo(int storeID, int storeAddressID, int companyAddressID,
			String storeName, String storePhoto, String companyName,
			String companyPhoto, String nickName, String address,String companyAddress) {
		this.storeID = storeID;
		this.storeAddressID = storeAddressID;
