...
public class Account {
	 ...
	 * @param accountPhoto 照片
	 * @param lastName 名字
	 */
	public Account(int accountID, int accountPrivilege, String firstName,String account,
			String password, String operatorID, String accountPhoto, String lastName,
			int sync, int phoneID) {
