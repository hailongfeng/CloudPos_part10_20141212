...
import com.cynovo.sirius.adapter.CheckSelfAdapter;
import com.cynovo.sirius.aidl.IPaySDK;
import com.cynovo.sirius.core.CheckSelfItemInfo;
import com.cynovo.sirius.devices.DeviceID;
...
//	}
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		mDialog = new AnyWhereDialog(getActivity(), 774, 406, 0, 0,
				R.layout.check_self, R.style.Theme_dialog, Gravity.CENTER, true);
...
//		}.start();
	...
	public void InitView() {
		mCheckStatus = (RadioButton) mDialog
				.findViewById(R.id.check_result_icon);
	...
	private void setItemInfo(final int deviceid, final boolean flag,
			final int infoid) {
	...
	private void setItemInfo(final int deviceid, final boolean flag,
		...
		handler.post(new Runnable() {
			@Override
			public void run() {
				mCheckSelfAdapter.addItemInfo(new CheckSelfItemInfo(deviceid,
						"", flag, info));
			}
		});
	}
