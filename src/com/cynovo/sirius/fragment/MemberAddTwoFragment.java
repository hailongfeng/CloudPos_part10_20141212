...
public class MemberAddTwoFragment extends AbstractDialogFragment implements OnClickListener,
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		String str = String.format("%04d/%02d/%02d", calendar.get(Calendar.YEAR),
	...
	public void onClick(View v) {
		...
		case R.id.memberAddDeadlineButton: // 有效期
			Calendar calendar=Calendar.getInstance();
			DatePickerDialog dpd = new DatePickerDialog(this.getActivity(), this,
	...
	private void addMember() {
		...
		CynovoHttpClient.post("api/membership/add_membership.php", params,
