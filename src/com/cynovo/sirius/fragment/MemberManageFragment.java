...
public class MemberManageFragment extends AbstractLoadingFragment implements OnClickListener,
		OnItemClickListener {
	...
	public void showCreateMemberDialog(String name, String phone) {
		MemberAddTwoFragment memberAddTwoFragment = new MemberAddTwoFragment(MemberManageFragment.this,
				name, phone);
