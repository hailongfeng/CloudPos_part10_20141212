...
import com.cynovo.sirius.core.order.OrdersToPaymentType;
...
public class JsonBean {
	...
	public void SetOrderProcess(int mode, long createtime, String traceno, String referenceno, 
			String authno, long cleardate, String ackno, String price, int longitude, int latitude) 
	...
	public void SetBankCard(String cardno, String validThrough, String owner, String phone, 
			String email, String signature) throws JSONException {
		JSONObject jsonObj = new JSONObject();
