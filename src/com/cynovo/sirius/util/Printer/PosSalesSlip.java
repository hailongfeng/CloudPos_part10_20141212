...
import com.cynovo.sirius.finance.CardIssuersManager;
import com.cynovo.sirius.finance.PosData;
import com.cynovo.sirius.util.BankCardNoFormater;
...
public class PosSalesSlip {
    ...
    private void ForSignature() {
    	...
    	mprinter.PrintLineFeed();
    	mprinter.PrintLineStr(ph.getPrintStringWithFormat("I ACKNOWLEDGE SATISFACTORY RECEIPT OF RELATIVE GOODS/SERVICE", 1, false));
    	mprinter.PrintLineFeed();
