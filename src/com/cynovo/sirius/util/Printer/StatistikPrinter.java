...
public class StatistikPrinter {
	...
	static void  printStatistik(StatisticsItem mStatisticsItem,String startTime,String endTime)
	{
		...
		mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
				Common.getString(R.string.sales_statistics), PrinterHelper.alignCenter, true));
		mPrinter.setMode(PrinterBase.NORMAL_SIZE);
		mPrinter.PrintLineFeed();
		mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
				Common.getString(R.string.p_mname),StoreManager.getStoreName(),PrinterHelper.alignSide,false));
		mPrinter.PrintLineFeed();
		mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
				Common.getString(R.string.p_start_date),startTime,PrinterHelper.alignSide,false));
		mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
				Common.getString(R.string.p_end_date),endTime,PrinterHelper.alignSide,false));
		mPrinter.PrintLineFeed();
		mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
				mPrinterHelper.getNString("-", 32),PrinterHelper.alignCenter,false));
		mPrinter.PrintLineFeed();
		mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
				Common.getString(R.string.p_total_amount),mStatisticsItem.getTotalAmount(),PrinterHelper.alignSide,false));
		mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
				Common.getString(R.string.p_cash_amount),mStatisticsItem.getCashAmount(),PrinterHelper.alignSide,false));
		mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
				Common.getString(R.string.p_card_amount),mStatisticsItem.getCardAmount(),PrinterHelper.alignSide,false));
		mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
				Common.getString(R.string.p_total_count),String.valueOf(mStatisticsItem.getCount()),PrinterHelper.alignSide,false));
		mPrinter.PrintLineFeed();
		mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
				mPrinterHelper.getNString("-", 32),PrinterHelper.alignCenter,false));
		mPrinter.PrintLineFeed();
	...
	static void  printProductCount(List<SaleProductInfo> saleProductList,String startTime,String endTime)
	{
		...
		{
			mPrinter.PrintLineStr(mPrinterHelper.getPrintStringWithFormat(
					Common.getString(R.string.p_no_record), PrinterHelper.alignLeft, true));
			mPrinter.PrintLineFeed();
		}
