...
import com.cynovo.sirius.fragment.LeftBarFragment;
...
public class AddFootView extends LinearLayout {
	...
	public AddFootView(Context context, LeftBarFragment leftbarDealFlipper,
			String name, int picture) {
		super(context);
		mContext = context;
	...
	private void getButton(String name, final int resId) {
		...
		BitmapDrawable bitmapleft = FileManager.readBitMapDrawable(mContext,
				resId);
		BitmapDrawable bitmapright = FileManager.readBitMapDrawable(mContext,
				R.drawable.recent_more);
