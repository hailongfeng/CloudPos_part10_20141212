...
//	    private int color;               //文字的颜色  
		...
		public boolean onTouchEvent(MotionEvent event) {
			...
			case MotionEvent.ACTION_DOWN:
				this.setBackgroundResource(draw1);
				if(!flag){
					Log.i("AAAAAAAAA", "CCCCCCCCCCCCCCCCC");
					button1.setBackgroundResource(draw3);
					button2.setBackgroundResource(draw4);
					button1.setFlag(false);
					button2.setFlag(false);
//					if(whichFlag == 0){
//						//商品分类
//					}else if(whichFlag == 1){
//						//商品属性
...
//					
			...
			case MotionEvent.ACTION_UP:
				this.setBackgroundResource(draw2);
				this.flag = true;
				break;
